...
const ProjectCard: FC<Props> = ({ project }) => {
  return (
    <div className="flex max-w-sm cursor-pointer flex-col justify-between space-y-2 rounded-xl bg-white/10 px-4 py-6 text-gray-400 shadow-sm transition duration-150 ease-in hover:bg-white/20 hover:text-gray-300 hover:shadow-md lg:max-w-md">
